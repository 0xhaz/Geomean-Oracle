...
/// for protocols that wish to use V3 style geomean oracle
contract GeoMeanOracle is BaseHook {
    using Oracle for Oracle.Observation[65535];
    using PoolIdLibrary for PoolKey;
    using StateLibrary for IPoolManager;

    /// @notice Oracle pools do not have fees because they exist to serve as an oracle for pair of tokens
    ...
    function increaseCardinality(PoolKey calldata key, uint16 cardinalityNext)
        external
